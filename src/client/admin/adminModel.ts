...
export type AdminPage = 'features' | 'operations' | 'preflight' | 'board' | 'winners' | 'session-history' | 'log' | 'roulette' | 'draw-ticket' | 'connection' | 'settings' | 'session-setup' | 'overlay' | 'more';
