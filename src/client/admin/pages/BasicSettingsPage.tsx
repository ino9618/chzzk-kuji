  ...
  return (
    <div className="admin-page basic-settings-page">
      ...
      <section className="workflow-section">
        ...
        <SettingRow title="기본 장당 가격" description="새 회차를 만들 때 처음 표시되는 치즈 금액입니다."><NumberStepper className="settings-price" aria-label="기본 장당 가격" min={1} step={100} suffix="치즈" value={draft.defaultTicketPrice} onValueChange={(defaultTicketPrice) => setDraft({ ...draft, defaultTicketPrice })} /></SettingRow>
